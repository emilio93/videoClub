...
HttpPrestamosFinalizar = function(url, metodo, args) {
    ...
    this.getCobro = function(idPrestamo, cedula, titulo) {
        var args = {'params': {'pedido': 'obtener', 'conjunto': 'cobro', 'id': idPrestamo}};
        var httpListar = new Http('prestamos/ejecutor', 'get', args);
        var esto = this;
        var solicitante = {
    ...
    this.finalizar = function(id, cedula, titulo) {
        ...
        var args = {'params': {'pedido': 'obtener', 'conjunto': 'cobro', 'id': id}};
        var httpListar = new Http('prestamos/ejecutor', 'get', args);
        var esto = this;
        var solicitante = {
            'ejecutar': function(data) {
